...
const testimonials: Testimonial[] = [
  {
    ...
    name: 'Sarah Johnson',
    role: 'Homeowner',
    content: 'EstateElite made finding our dream home an absolute pleasure. Their attention to detail and understanding of our needs was exceptional. Highly recommend their services!',
    rating: 5,
  ...
  },
  {
    ...
    content: 'As an investor, I needed an agency that understood the market deeply. EstateElite exceeded my expectations with their market insights and professional guidance.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Buying my first home was intimidating, but the team at EstateElite guided me through every step with patience and expertise. I couldn\'t be happier with my new home!',
    rating: 4,
